...
function NewUsedPropertyIncome() {
  ...
  const [res, HandleSubmit] = usePostData({
    url: "http://localhost:5000/postNewUsedPropertIncome",
    Data: data,
  });
  const TableHeading = [
    t("Order"),
            ...
            <div className="col-2">
              <div className="col-2f">
                <div className="input-control">
                  ...
                  <input type="text" placeholder={t("Model19ሐ")} disabled />
                </div>
                <div className="input-control">
...
export default NewUsedPropertyIncome;
