...
function EditEmployee() {
  ...
  const [res, HandleSubmit] = usePutData({
    url: "http://localhost:5000/EditEmployee",
    Data: data,
  });
            ...
            <form action="">
              <div className="Form-Control">
                <div className="input-control">
                  ...
                  <input
                    ...
                    id="first-name"
                    onChange={(e) => {
                      dispatch({ type: "id", value: employe.ID }),
                ...
                <div className="input-control">
                  ...
                  <input
                    ...
                    id="middle-name"
                    onChange={(e) =>
                      dispatch({ type: "MidleName", value: e.target.value })
                    }
                  />
                </div>
                <div className="input-control">
              ...
              <div className="Form-Control">
                <div className="input-control">
                  ...
                  >
                    ...
                    {CostCenternName?.map((data, index) => {
                      return (
                        <option
                          value={CostCenternName[index].Offices_Name}
                          key={index}
                        >
                          {CostCenternName[index].Offices_Name}
                        </option>
                      );
                    })}
                  </select>
                ...
                <div className="input-control">
                  ...
                  <select
                    ...
                    id="WorkPlaceName"
                    onChange={(e) =>
                      dispatch({ type: "WorkPlaceName", value: e.target.value })
                    }
                  >
                    <option defaultValue>{t("WorkPlaces")}</option>
                    {WorkPlaceName?.map((data, index) => {
                      return (
                        <option key={index}>{WorkPlaceName[index].Name}</option>
                      );
                    })}
                  </select>
                </div>
              ...
              <div className="Form-Control">
                <div className="input-control">
                  ...
                  <fieldset>
                    <img
                      src={`../image/${data.Photo ? data.Photo : "1vajvt.jpg"}`}
                      alt=""
