...
function PropertyRegistration() {
  ...
  const { t } = getContext;
  const [PropertyCategory] = useGetData(
    "http://localhost:5000/getClassfication"
  );
          ...
          <div className="form-countainer">
            <form action="">
              <div className="Form-Control">
                <div className="input-control">
                  ...
                  >
                    ...
                    {PropertyCategory?.map((data, index) => {
                      return (
                        <option
                          value={PropertyCategory[index].Offices_Name}
                          key={index}
                        >
                          {PropertyCategory[index].Classification_Name}
                        </option>
                      );
                    })}
                  </select>
                ...
                <div className="input-control">
                  <label htmlFor="PropertySubcategory">
                    {t("PropertySubcategory")}
                  </label>
                  <select
                    name=""
                  ...
                  >
                    ...
                    {SubCategory?.map((data, index) => {
                      return (
                        <option key={index}>
                          {SubCategory[index].Sub_Classification_Name}
                        </option>
                      );
                    })}
                  </select>
              ...
              <div className="Form-Control">
                <div className="input-control">
                  ...
                  <input
                    ...
                    id="Model"
                    onChange={(e) =>
                      dispatch({ type: "Model", value: e.target.value })
                    }
                  />
                </div>
                <div className="input-control">
                  ...
                  <input
                    ...
                    id="ShelfNumber"
                    onChange={(e) =>
                      dispatch({ type: "ShelfNumber", value: e.target.value })
                    }
                  />
                </div>
                <div className="input-control">
                  ...
                  <fieldset>
                    <label htmlFor="Fixed">
                      ...
                      <input
                        ...
                        value="ቆሚ ንብረት"
                        onClick={(e) =>
                          dispatch({ type: "ItemType", value: e.target.value })
                        }
                      />
                    </label>
                    <label htmlFor="PropertyII">
                      {t("PropertyII")}
                      <input
                        type="radio"
                        id="PropertyII"
              ...
              <div className="Form-Control">
                ...
                <div className="input-control">
                  ...
                  <input
                    ...
                    id="MinValue"
                    onChange={(e) =>
                      dispatch({ type: "MinValue", value: e.target.value })
                    }
                  />
                </div>
                <div className="input-control">
                  ...
                  <input
                    ...
                    id="MaxValue"
                    onChange={(e) =>
                      dispatch({ type: "MaxValue", value: e.target.value })
                    }
                  />
                </div>
                <div className="input-control">
              ...
              <div className="Form-Control">
                <div className="input-control">
                  ...
                  <fieldset>
                    <img
                      src={`../image/${data.Photo ? data.Photo : "store.jpg"}`}
                      alt=""
                ...
                <div className="input-control">
                  ...
                  <textarea
                    onChange={(e) =>
                      dispatch({ type: "Describtion", value: e.target.value })
                    }
                    id="Describtion"
                    cols="30"
                    rows="9"
                ...
                <div className="input-control">
                  <div className="submit-control">
                    ...
                    <button style={{ background: "#DA0037" }} type="submit">
                      {t("Cancle")}
                    </button>
                  </div>
                </div>
